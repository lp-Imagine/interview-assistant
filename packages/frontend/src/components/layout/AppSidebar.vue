...
const mainMenu: Array<{
  ...
  },
  {
    label: "模拟面试",
    path: "/interview",
    icon: '<path d="M12 2a7 7 0 0 0-7 7c0 2.38 1.19 4.47 3 5.74V17a2 2 0 0 0 2 2h4a2 2 0 0 0 2-2v-2.26c1.81-1.27 3-3.36 3-5.74a7 7 0 0 0-7-7z"/><path d="M9 21h6"/><path d="M10 17v4"/><path d="M14 17v4"/>',
  },
  {
    label: "设置",
    path: "/settings",
